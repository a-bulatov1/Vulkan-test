...
private:
    ...
    void createInstance() {
        ...
        uint32_t extensionCount = 0; // Available Extensions
        vkEnumerateInstanceExtensionProperties(nullptr, &extensionCount, nullptr);
        std::vector<VkExtensionProperties> availableExtensions(extensionCount);
        vkEnumerateInstanceExtensionProperties(nullptr, &extensionCount, availableExtensions.data());

        std::cout << "available extension(s):\n";
    ...
    void createSwapChain() {
        ...
        createInfo.preTransform = swapChainSupport.capabilities.currentTransform; // transformations to the window, like a rotation
        createInfo.compositeAlpha = VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR; // transparent windows???
        createInfo.presentMode = presentMode;
        createInfo.clipped = VK_TRUE; // pixel culling for obscured pixels (windows covering other windows)
    ...
    VkImageView createImageView(VkImage image, VkFormat format) {
        ...
        createInfo.viewType = VK_IMAGE_VIEW_TYPE_2D; // images as 1D, 2D, 3D textures, or cube maps
        createInfo.format = format;
        // no mipmapping levels or multiple layers, used as color targets
    ...
    void createRenderPass() {
        ...
        VkAttachmentReference colorAttachmentRef{}; // subpass
    ...
    void createGraphicsPipeline() {
        ...
        rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE; // vertex order that determines "front faces" and "back faces"
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("textures/minecraft.png", &texWidth, &texHeight, 
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        // Identity matrix, time * 90 degree rotation, z-axis
        ubo.model = glm::rotate(glm::mat4(1.0f), time * glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        // Eye position, center position, up axis
        ubo.view = glm::lookAt(glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        // 45 degree FOV, aspect ratio, near view plane, far view plane
        ubo.proj = glm::perspective(glm::radians(45.0f), swapChainExtent.width / (float) swapChainExtent.height, 0.1f, 10.0f);
        // Compensate for the fact that glm was originally for OpenGL, which had an inverted Y coordinate
        ubo.proj[1][1] *= -1;
    ...
    bool checkValidationLayerSupport() { // Validation Layer Support
        uint32_t layerCount;
    ...
    std::vector<const char*> getRequiredExtensions() { // Required Extensions based on Validation layers
    ...
    void populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
        ...
        // Remove or add to choose which error messages to show/ignore.
