...
private:
    ...
    void createGraphicsPipeline() {
        ...
        vertexInputInfo.pVertexBindingDescriptions = nullptr; //optional for hardcoded vertices
        vertexInputInfo.vertexAttributeDescriptionCount = 0;
        vertexInputInfo.pVertexAttributeDescriptions = nullptr; //similarly optional
    ...
    void createImageViews() {
        ...
        for (size_t i = 0; i < swapChainImages.size(); i++) {
            ...
            // no mipmanning levels or multiple layers, used as color targets
